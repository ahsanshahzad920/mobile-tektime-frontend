...
const RegisterMoment = () => {
  ...
  return (
                ...
                {step === 1 && (
                  <>
                    <div className="step-content">
                      <h1 className="form-title">TEKTIME TRANSFORME VOS RÉUNIONS EN COMPTES RENDUS CLAIRS ET EXPLOITABLES</h1>

                      <div className="form-section">
                        <p className="mb-4">Grâce à la prise de notes automatique par l'audio.</p>
                        <p className="mb-4">
                          En présentiel ou à distance (Zoom, Teams, Google Meet, téléphone…), ne vous souciez plus de rédiger :
                          TekTIME écoute, structure et organise vos discussions.
                        </p>
                      </div>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">🎯 Le problème</h4>
                        <div className="needs-grid mb-4">
                          {[
                            "Des réunions où personne ne prend de notes.",
                            "Des comptes rendus envoyés trop tard (ou jamais).",
                            "Des décisions oubliées, des responsabilités floues, des actions non suivies.",
                            "Une perte de temps et d'énergie qui coûte cher à l'entreprise."
                          ].map((item, index) => (
                      ...
                      <div className="form-section">
                        <h4 className="section-title">💡 La solution TekTIME</h4>
                        <p className="mb-4">Avec TekTIME, chaque réunion devient une source d'information claire et actionnable :</p>

                        <div className="needs-grid mb-4">
                          {[
                            "✅ Enregistrement audio sécurisé – en salle ou en ligne, TekTIME s'adapte.",
                            "✅ Transcription automatique – l'IA transforme l'oral en écrit.",
                            "✅ Synthèse intelligente – décisions, tâches et points clés sont identifiés automatiquement.",
                            "✅ Suivi intégré – retrouvez chaque réunion dans un espace organisé, consultable par tous."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">📌 Cas d'usage</h4>
                        <Row className="g-3 mb-4">
                          {[
                            "Réunion d'équipe → décisions et actions directement listées.",
                            "Comité projet → suivi précis de l'avancement sans effort.",
                            "Rendez-vous client → comptes rendus envoyés en un clic après l'échange.",
                            "Entretien RH → conserver l'historique des discussions et des engagements."
                          ].map((item, index) => (
                            <Col md={6} key={index}>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">📊 Les bénéfices immédiats</h4>
                        <div className="needs-grid mb-4">
                          {[
                            "⏱ Gagnez 2h par réunion en éliminant la prise de notes manuelle.",
                            "🔍 Réduisez de 70% les oublis de décisions et d'actions.",
                            "🤝 Améliorez la collaboration grâce à une mémoire commune partagée.",
                            "📈 Accélérez vos projets en évitant les allers-retours liés aux malentendus."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">✨ Pourquoi TekTIME est différent</h4>
                        <div className="needs-grid mb-4">
                          {[
                            "Indépendant des outils de visioconférence : fonctionne partout.",
                            "Interface simple : pas besoin de former vos équipes.",
                            "Pensé pour le quotidien des managers, chefs de projets, commerciaux et consultants."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
                      ...
                      <div className="form-section text-center">
                        <h4 className="section-title">Découvrez TekTIME en action</h4>
                        ...
                        {/* <p className="text-muted">Regardez comment TekTIME transforme vos réunions en quelques minutes</p> */}
                      </div>
                      ...
                      <div className="text-center mt-4 small text-muted">
                        <p>
                          ...
                          <a href="https://tektime.fr" className="text-decoration-none ms-1">tektime.fr</a> -
                          <a href="mailto:fondateur@tektime.fr" className="text-decoration-none ms-1">fondateur@tektime.fr</a> -
                          <a href="https://www.instagram.com/tektime.io/" className="text-decoration-none ms-1">Instagram</a>
                        </p>
                      </div>
                    </div>
                    <div className="form-section container py-5">
                      <h2 className="form-title text-center mb-3">💰 Nos Tarifs</h2>
                      <p className="text-muted text-center mb-5">
                        Choisissez la formule adaptée à vos besoins pour tester TekTIME Moment
                      </p>

                      <div className="row g-4">
                        {[
                          {
                            title: "Tarif par semaine pour une licence",
                            price: "12€",
                            duration: "HT",
                            desc: "Accès complet pendant 7 jours pour tester TekTIME.",
                          },
                          {
                            title: "Tarif par mois pour une licence",
                            price: "40€",
                            duration: "HT",
                            desc: "Profitez de TekTIME pendant 30 jours avec toutes les fonctionnalités.",
                            featured: true,
                          },
                          {
                            title: "Tarif par an pour une licence",
                            price: "400€",
                            duration: "HT",
                            desc: "La formule la plus avantageuse pour une utilisation sur 12 mois.",
                          },
                          {
                            title: "Pour plus de licence Contactez-nous",
                            price: "",
                            duration: "",
                            desc: "",
                            button: "Contact us",
                          ...
                          <div
                            key={index}
                            className={`col-12 col-md-6 col-lg-4 ${index === 3 ? "mx-auto" : ""
                              }`}
                          >
                            <div
                              className={`card h-100 shadow-sm ${item.featured ? "border-primary border-2 shadow-lg" : ""
                                }`}
                            >
                              <div className="card-body d-flex flex-column">
                                ...
                                <h2 className="text-primary fw-bold mb-3">
                                  {item.price}{" "}
                                  <small className="text-muted fs-6">{item.duration}</small>
                                </h2>
                                <p className="card-text flex-grow-1">{item.desc}</p>
                                {item?.button && (
                                  <a
                                    href="https://tektime.io/destination/uKnsk22F2gvNxC5F5a2s2jp5pts8XbxPk22zZ9qf/167482"
    ...
    <p className="text-muted">
      Pour plus d’une licence entreprise, merci de nous contacter :
    </p>
    <a
  ...
  <div className="max-w-5xl mx-auto text-center px-6">
    <h2 className="text-3xl font-bold mb-6 text-gray-800">Nos Tarifs</h2>
    <p className="text-gray-600 mb-12">
      Choisissez la formule adaptée à vos besoins pour tester TekTIME  [NAME OF THE LANDING PAGE]
    </p>

    <div className="grid md:grid-cols-3 gap-8">
      <div className="bg-white rounded-2xl shadow p-8 border border-gray-100">
        <h3 className="text-xl font-semibold mb-4 text-gray-800">Licence Entreprise - Test 1 semaine</h3>
        <p className="text-4xl font-bold text-indigo-600 mb-4">12€ <span className="text-lg text-gray-500">HT</span></p>
        <p className="text-gray-500 mb-6">Accès complet pendant 7 jours pour tester TekTIME.</p>
        <a href="#contact" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-xl shadow hover:bg-indigo-700 transition">
          Essayer 1 semaine
        </a>
      </div>

      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-indigo-600">
        <h3 className="text-xl font-semibold mb-4 text-gray-800">Licence Entreprise - Test 1 mois</h3>
        <p className="text-4xl font-bold text-indigo-600 mb-4">40€ <span className="text-lg text-gray-500">HT</span></p>
        <p className="text-gray-500 mb-6">Profitez de TekTIME pendant 30 jours avec toutes les fonctionnalités.</p>
        <a href="#contact" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-xl shadow hover:bg-indigo-700 transition">
          Essayer 1 mois
        </a>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow p-8 border border-gray-100">
        <h3 className="text-xl font-semibold mb-4 text-gray-800">Licence Entreprise - 1 an</h3>
        <p className="text-4xl font-bold text-indigo-600 mb-4">400€ <span className="text-lg text-gray-500">HT</span></p>
        <p className="text-gray-500 mb-6">La formule la plus avantageuse pour une utilisation sur 12 mois.</p>
        <a href="#contact" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-xl shadow hover:bg-indigo-700 transition">
          S’abonner 1 an
        </a>
      </div>
    ...
    <div className="mt-12 text-gray-600">
      <p>Pour plus d’une licence entreprise, merci de nous contacter :</p>
      <a href="mailto:fondateur@tektime.fr" className="text-indigo-600 font-medium hover:underline">fondateur@tektime.fr</a>
    </div>
  </div>
</section> */}
                  </>
