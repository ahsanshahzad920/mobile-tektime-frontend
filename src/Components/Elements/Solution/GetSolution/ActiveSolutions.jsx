...
const ActiveSolutions = ({ allMeetings }) => {
  const { isLoading, getPrivateSolutions } = useSolutions();
  const {
    open,
    handleShow,
    setSolution,
                ...
                <div className="row">
                  <div className="col-12">
                    ...
                    {/* {item?.status !== "in_progress" && (
                      <span
                        className={`badge ms-2 solution-badge-red`}
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="">
                      <div className="d-flex align-items-center">
                        ...
                        <span
                          className={`badge ms-2 ${item?.solution_privacy === "private"
                            ? "solution-badge-red"
                            : item?.solution_privacy === "public"
    ...
    <div className="scheduled">
      ...
      <div className="my-2 container-fluid">
        {allMeetings?.length === 0 && !isLoading ? (
          <NoContent title="Active Solution" />
...
export default ActiveSolutions;
