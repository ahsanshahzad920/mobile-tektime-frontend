...
import { FaCalendarCheck, FaRobot, FaComments } from "react-icons/fa";
...
export const getOptions = (t, roleId) => {
  const options = [
    ...
    },
    {
      ...
      label: t("meeting.newMeeting.options.activityTypes.socialMediaNewsletter"),
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="37"
    ...
    {
      title: "AI Social Media Newsletter",
      label: t("meeting.newMeeting.options.activityTypes.aiSocialMediaNewsletter"),
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="37"
  ...
  // Filter out "Newsletter", "Social Media Newsletter" and "Quiz" for user IDs 2, 3, 4, or 5
  if ([2, 3, 4, 5].includes(roleId)) {
    return options.filter(
      (option) =>
        option.title !== "Newsletter" &&
        option.title !== "Social Media Newsletter" &&
        option.title !== "AI Social Media Newsletter" &&
        option.title !== "Quiz"
    );
  }
