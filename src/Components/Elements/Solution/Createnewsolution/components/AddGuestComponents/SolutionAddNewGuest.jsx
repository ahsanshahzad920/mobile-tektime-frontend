...
import AddSolutionTeam from "./AddSolutionTeam";
...
const SolutionAddNewGuest = ({ show, handleClose,editModal }) => {
                ...
                <div className=" col-md-12">
                    ...
                    <Row>
                        <Col md={12}>
                                                    ...
                                                    {contribution.showFields && (
                                                        <>
                                                            ...
                                                            >
                                                                {loading ? (
                                                                    <button
                                                                        className={`btn moment-btn px-2 py-0`}
                                                                    >
                                                                        <span
                            ...
                            {selectedTab === "team" && <AddSolutionTeam handleClose={handleClose} />}
                        </Col>
                    </Row>
                </div>
...
export default SolutionAddNewGuest;
