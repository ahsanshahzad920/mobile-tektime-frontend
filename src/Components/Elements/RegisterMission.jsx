                ...
                {step === 1 && (
                  <>
                    <div className="step-content">
                      <h1 className="form-title">NE PERDEZ PLUS LE FIL DE VOS PROJETS ET MISSIONS</h1>

                      <div className="form-section">
                        <p className="mb-4">
                          Avec TekTIME, chaque mission est suivie de manière simple, précise et surtout automatisée.
                        </p>
                        <p className="mb-4">
                          Finis les tableurs dispersés, les comptes rendus manquants et les dépassements invisibles.
                        </p>
                      </div>
                      ...
                      <div className="form-section">
                        ...
                        <div className="needs-grid mb-4">
                          {[
                            "Des projets qui dépassent leurs délais sans alerte claire.",
                            "Des comptes rendus d'activité chronophages à rédiger.",
                            "Une visibilité limitée sur le temps passé et les ressources mobilisées.",
                            "Des factures imprécises qui créent des tensions avec les clients."
                          ].map((item, index) => (
                      ...
                      <div className="form-section">
                        <h4 className="section-title">💡 La solution TekTIME : le cockpit de mission intelligent</h4>
                        <p className="mb-4">Chaque mission devient un tableau de bord vivant, qui s'alimente automatiquement :</p>

                        <div className="needs-grid mb-4">
                          {[
                            "👉 Suivi planning – visualisez en temps réel les échéances et les dépassements.",
                            "👉 Moments clés – capturez les étapes et jalons importants de vos projets.",
                            "👉 Casting – suivez qui fait quoi et combien de temps a été réellement passé.",
                            "👉 Fichiers centralisés – plus besoin de chercher, tout est attaché à la mission.",
                            "👉 Suivi budgétaire – gardez le contrôle sur les coûts et marges.",
                            "👉 Jours de travail – vision claire de l'implication de chaque collaborateur."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">🔥 La valeur unique : le compte rendu automatique</h4>
                        <p className="mb-4">
                          Avec TekTIME, chaque activité réalisée sur la mission est enregistrée et consolidée sans saisie manuelle.
                          Résultat :
                        </p>

                        <Row className="g-3 mb-4">
                          {[
                            "✅ Un compte rendu prêt à l'emploi en fin de mission.",
                            "✅ Une facturation en temps réel, juste et transparente.",
                            "✅ Un historique exploitable pour améliorer vos futurs projets."
                          ].map((item, index) => (
                            <Col md={6} key={index}>
                      ...
                      <div className="form-section">
                        ...
                        <div className="needs-grid mb-4">
                          {[
                            "⏱ Économisez des heures chaque semaine sur le reporting.",
                            "🔍 Ayez une vision 360° sur vos missions en cours.",
                            "🤝 Renforcez la confiance avec vos clients grâce à des suivis fiables et objectifs.",
                            "📈 Améliorez votre rentabilité en détectant rapidement les dérives de charge et de budget."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
                      ...
                      <div className="form-section">
                        <h4 className="section-title">✨ TekTIME change la gestion de mission</h4>
                        <div className="needs-grid mb-4">
                          {[
                            "Automatisation totale du suivi (moins d'effort, plus de valeur).",
                            "Interface simple et intuitive, pensée pour les agences, ESN, freelances et équipes projets.",
                            "Un espace unique pour piloter, collaborer et rendre compte."
                          ].map((item, index) => (
                            <div key={index} className="need-item">
                              <span className="need-text">{item}</span>
                            </div>
        ...
        ></iframe>
                    ...
                    <div className="form-section container py-5">
                      ...
                      <p className="text-muted text-center mb-5">
                        Choisissez la formule adaptée à vos besoins pour tester TekTIME Mission
                      </p>
