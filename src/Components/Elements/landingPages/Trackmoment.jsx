      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 mt-3" data-aos="fade-down">
            ...
            <p className="description hero-description">{t("track.subtitle2")}</p>
            <p className="description hero-description">{t("track.subtitle3")}</p>
            <p className="description hero-description">{t("track.subtitle4")}</p>
            <p className="description hero-description">{t("track.subtitle5")}</p>
            <p className="description hero-description">{t("track.subtitle6")}</p>
